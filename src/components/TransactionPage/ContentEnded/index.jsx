...
import TiketExp from "./tiket"

const ContentTransactionEnded = () =>{
    return <>
            ...
            <Box display={"flex"} justifyContent={"space-between"} backgroundColor={"rgb(251, 251, 251)"} width={"83%"} height={"80%"} marginTop={"20px"}>
                <Tabs justifyContent={"center"} width={"63%"} height={"50px"}>
                    ...
                    <TabPanels>
                        ...
                        <Box>
                            <TiketExp judulKeterangan={"VIP Denny Caknan @ Pintulangit (Berdiri)"} waktu={"03:00 WIB"} harga={"Rp 100.000"} status={"EVENT ENDED"}/>
                            <TiketExp judulKeterangan={"Festival Denny Caknan @ Pintulangit"} waktu={"03:00 WIB"} harga={"Rp 50.000"} status={"EVENT ENDED"}/>
                            <TiketExp judulKeterangan={"Tribun Denny Caknan @ Pintulangit (Duduk)"} waktu={"19:00 WIB"} harga={"Rp 75.000"} status={"EVENT ENDED"}/>
                            <TiketExp judulKeterangan={"Tiket anak-anak (1-10 tahun) ALL CATEGORY"} waktu={"15:00 WIB"} harga={"Rp 25.000"} status={"EVENT ENDED"}/>
                        </Box>
                    </TabPanels>
                </Tabs>
                <Box width={"33%"} height={"auto"}>
                    <Box className="stickyy" backgroundColor={"rgb(251, 251, 251)"} width={"100%"} height={"auto"}>
                        <Box className="boxShadow" display={"flex"} backgroundColor={"white"} flexDirection={"column"} width={"100%"} height={"170px"} alignItems={"center"} borderRadius={"8px"}>
                            <Text color={"grey"} width={"86%"} marginTop={"15px"} fontSize={"15px"}>Maaf event ini telah berakhir, silahkan temukan</Text>
                            <Text color={"grey"} width={"86%"} marginTop={"5px"} fontSize={"15px"}>event menarik lainnya</Text>
                            <Button onClick={""} _hover={{backgroundColor:"blue"}} fontWeight={"400"} className="button"color={"white"} display={"flex"} justifyContent={"center"} alignItems={"center"} width={"86%"} height={"50px"} borderRadius={"10px"} backgroundColor={"blue"}>Cari Event</Button>
                        </Box>
...
export default ContentTransactionEnded 