  ...
  return (
    <>
      ...
      >
        ...
        <Box onClick={() => navigate("/landing")} _hover={{color:"white", marginLeft:"10px", transition:"all 0.5s ease"}} display={"flex"} height={"40px"} width={"100%"} alignItems={"center"} justifyContent={"flex-start"} cursor={"pointer"} color={"grey"} marginTop={"12px"} >
